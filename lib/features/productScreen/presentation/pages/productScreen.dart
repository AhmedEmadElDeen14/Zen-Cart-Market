...
import 'package:zen_cart_market/features/productScreen/data/data_sources/products_ds_impl.dart';
import 'package:zen_cart_market/features/productScreen/data/repositories/specific_product_repo_impl.dart';
import 'package:zen_cart_market/features/productScreen/domain/use_cases/specific_product_useCase.dart';
import 'package:zen_cart_market/features/productScreen/presentation/bloc/specific_product_bloc.dart';
...
class _ProductScreenState extends State<ProductScreen> {
  ...
  Future<void> _refresh(BuildContext context) async {
    BlocProvider.of<SpecificProductBloc>(context).add(GetSpecificProductEvent(widget.product.id??""));
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(
          create: (context) => SpecificProductBloc(
            GetSpecificProductUseCase(
              SpecificProductRepoImpl(
                ProductDSImpl(
                  ApiManager(),
                ),
              ),
      ...
      child: BlocConsumer<WishlistBloc, WishlistState>(
        ...
        builder: (context, state) {
          return BlocConsumer<SpecificProductBloc, SpecificProductState>(
            listener: (context, state) {
              if (state.type == ScreenType.specificProductFailures) {
                showDialog(
                  context: context,
                  builder: (context) => AlertDialog(
                    title: Text("Error"),
                    content:
                        Text(state.failures?.message ?? "An error occurred."),
                  ),
                );
              }
              if (state.type == ScreenType.specificProductSuccess) {}
            },
            builder: (context, state) {
              return state.specificProductModel == null
                  ? Center(
                  ...
                  : Scaffold(
                      ...
                      appBar: AppBar(
                        title: Text(
                          state.specificProductModel!.data!.title ?? "",
                              ...
                              Column(
                                children: [
                                  CarouselSlider.builder(
                                    ...
                                    itemCount: state.specificProductModel!.data!
                                        .images!.length,
                                    itemBuilder: (BuildContext context,
                                        int index, int realIndex) {
                                      String imageUri = state
                                      ...
                                      if (isValidUri(imageUri)) {
                                        ...
                                        String url =
                                            "https://ecommerce.routemisr.com/Route-Academy-products/${imageUri}";
                                        return Container(
                                          width:
                                              MediaQuery.of(context).size.width,
                                  ...
                                  SmoothPageIndicator(
                                      controller: PageController(
                                          initialPage: currentImage),
                                      count: state.specificProductModel!.data!
                                          .images!.length,
                                      effect: SlideEffect(
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        Expanded(
                                          child: Text(
                                            state.specificProductModel!.data!
                                                    .title ??
                                                "",
                                    ...
                                    AnimatedRatingStars(
                                      initialRating: state.specificProductModel!
                                          .data!.ratingsAverage!
                                          .toDouble(),
                                      onChanged: (double) {},
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Text(
                                          "\$${state.specificProductModel!.data!.price}",
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            Text(
                                              "${state.specificProductModel!.data!.ratingsAverage} ",
                                            ...
                                            Text(
                                              "(${state.specificProductModel!.data!.ratingsQuantity} Review)",
                                    ...
                                    ElevatedButton(
                                      ...
                                      child: Container(
                                        ...
                                        child: Text(
                                          "Add To Cart",
                                          style:
                                              FormTextStyle.buttonText.copyWith(
